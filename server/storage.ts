...
export class MemStorage implements IStorage {
  ...
  async createNovel(insertNovel: InsertNovel): Promise<Novel> {
    ...
    const novel: Novel = {
      ...
      contentType: insertNovel.contentType || "fiction",
      nonFictionSubtype: insertNovel.nonFictionSubtype || null,
      nonFictionTopic: insertNovel.nonFictionTopic || null,
      targetAudience: insertNovel.targetAudience || null,
      bibliography: [],
      excludedSources: insertNovel.excludedSources || ["wikipedia.org", "wiki"],
  ...
  async createAudiobook(insertAudiobook: InsertAudiobook): Promise<Audiobook> {
    ...
    const audiobook: Audiobook = {
      ...
      ttsProvider: insertAudiobook.ttsProvider || 'deepgram',
      voice: insertAudiobook.voice || 'aura-2-athena-en',
      model: insertAudiobook.model || 'aura-2',
