  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Read the Terms of Use for AI KDP Author. Understand your rights and responsibilities when using our AI-powered novel generation and publishing platform." />
